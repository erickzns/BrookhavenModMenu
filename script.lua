...
local buttonFunctions = {
    ...
    VEICULOS = {
        {"Car Spawn", function() spawnVehicle("Carro") end},
        {"Plane Spawn", function() spawnVehicle("Avião") end},
        {"Helicopter Spawn", function() spawnVehicle("Helicóptero") end},
        {"Boat Spawn", function() spawnVehicle("Barco") end},
        {"Vehicle Speed Boost", function() print("Aumento de velocidade do veículo!") end},
    },
    TROLLS = {
        {"Fake Admin", function() print("Você agora é um Fake Admin!") end},
        {"No Clip", noClip},
        ...
        {"Chat Spammer", chatSpammer},
        {"Teleport To Random Position", teleportToRandom},
        {"Invisible Player", function() print("Jogador invisível!") end},
        {"Freeze All", function() print("Congelando todos os jogadores!") end},
        {"Remove All Vehicles", function() print("Removendo todos os veículos!") end},
        {"Fake Ban", fakeBan},
        {"Random Weather", function() print("Clima aleatório ativado!") end},
    }
}
...
local buttonNames = {"GERAL", "ARMA", "JOGADORES", "VEICULOS", "TROLLS"}
